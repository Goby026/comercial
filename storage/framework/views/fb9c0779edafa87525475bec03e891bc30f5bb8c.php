			...
			<div class="modal-body">
				<div class="tabbable" id="tabs-51352">
					<ul class="nav nav-tabs">
						...
						<li class="nav-item">
							<a class="nav-link" href="#panel-<?php echo e($tipo->codiTipoCliente); ?>" data-toggle="tab"><?php echo e($tipo->nombreTipoCliente); ?></a>
						</li>
						<?php endforeach; ?>
					</ul>
					<div class="tab-content">
						<?php foreach($tipoClientes as $tipo): ?>
						<div class="tab-pane" id="panel-<?php echo e($tipo->codiTipoCliente); ?>">
							<?php if($tipo->codiTipoCliente == 'TC_3_5_201869111138534101227'): ?>							
							<div class="form-group">
								<label for="">Nombres</label>
								<input type="text" name="txt_nombreClienNatu" class="form-control" placeholder="nombre..." value="<?php echo e(old('txt_nombreClienNatu')); ?>">
							</div>
							<div class="form-group">
								<label for="">Apellido Paterno</label>
								<input type="text" name="txt_apePaterClienN" class="form-control" placeholder="apellido paterno..." value="<?php echo e(old('txt_apePaterClienN')); ?>">
							</div>
							<div class="form-group">
								<label for="">Apellido Materno</label>
								<input type="text" name="txt_apeMaterClienN" class="form-control" placeholder="apellido materno..." value="<?php echo e(old('txt_apeMaterClienN')); ?>">
							</div>
							<div class="form-group">
								<label for="">Dni</label>
								<input type="text" name="txt_dniClienNatu" class="form-control" placeholder="dni..." value="<?php echo e(old('txt_dniClienNatu')); ?>">
							</div>
							<div class="form-group">
								<label for="">Dirección</label>
								<input type="text" name="txt_direcClienNatu" class="form-control" placeholder="dirección..." value="<?php echo e(old('txt_direcClienNatu')); ?>">
							</div>
							<div class="form-group">
								<label for="">Distrito</label>
								<input type="text" name="txt_codiDistri" class="form-control" placeholder="distrito..." value="<?php echo e(old('txt_codiDistri')); ?>">
							</div>
							<div class="form-group">
								<label for="">Provincia</label>
								<input type="text" name="txt_codiProvin" class="form-control" placeholder="provincia..." value="<?php echo e(old('txt_codiProvin')); ?>">
							</div>
							<div class="form-group">
								<label for="">Departamento</label>
								<input type="text" name="txt_codiDepar" class="form-control" placeholder="departamento..." value="<?php echo e(old('txt_codiDepar')); ?>">
							</div>
							<div class="form-group">
								<label for="">Fecha de Nacimiento</label>
								<input type="date" name="txt_fechaNaciClienN" class="form-control" placeholder="fecha de nacimiento..." value="<?php echo e(old('txt_fechaNaciClienN')); ?>">
							</div>
							<div class="form-group">
								<label for="">Email</label>
								<input type="email" name="txt_correoClienNatu" class="form-control" placeholder="email..." value="<?php echo e(old('txt_correoClienNatu')); ?>">
							</div>
							<div class="form-group">
								<label for="">Teléfono 01</label>
								<input type="text" name="txt_tele01ClienNatu" class="form-control" placeholder="telefono 01..." value="<?php echo e(old('txt_tele01ClienNatu')); ?>">
							</div>
							<div class="form-group">
								<label for="">Teléfono 02</label>
								<input type="text" name="txt_tele02ClienNatu" class="form-control" placeholder="telefono 02..." value="<?php echo e(old('txt_tele02ClienNatu')); ?>">
							</div>
							<?php else: ?>
							<div class="form-group">
								<label for="">Razon Social</label>
								<input type="text" id="txt_razonSocial" name="txt_razonSocial" class="form-control" placeholder="Razon social..." value="<?php echo e(old('txt_razonSocial')); ?>">
							</div>
							<div class="form-group">
								<label for="">Ruc</label>
								<input type="text" name="txt_ruc" class="form-control" placeholder="Ruc..." value="<?php echo e(old('txt_ruc')); ?>">
							</div>
							<div class="form-group">
								<label for="">Dirección</label>
								<input type="text" name="txt_direccion" class="form-control" placeholder="Dirección..." value="<?php echo e(old('txt_direccion')); ?>">
							</div>
							<div class="form-group">
								<label for="">Distrito</label>
								<input type="text" name="txt_codiDistri" class="form-control" placeholder="Distrito..." value="<?php echo e(old('txt_codiDistri')); ?>">
							...
							<div class="form-group">
								...
								<select name="idTipocli" class="form-control">
									<?php foreach($tipoClientesJuridicos as $tipos): ?>
									<option value="<?php echo e($tipos->codiTipoCliJur); ?>"><?php echo e($tipos->descTipoCliJur); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
							<div class="form-group">
								<label for="">Web</label>
								<input type="text" name="txt_web" class="form-control" placeholder="Web..." value="<?php echo e(old('txt_web')); ?>">
							</div>
							<?php endif; ?>
						</div>
						<?php endforeach; ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label for="">Nombres</label>
					<input type="text" name="txt_nombreContacClien" class="form-control" placeholder="nombre..." value="<?php echo e(old('txt_nombreContacClien')); ?>">
				</div>
				<div class="form-group">
					<label for="">Apellido Paterno</label>
					<input type="text" name="txt_apePaterContacC" class="form-control" placeholder="apellido paterno..." value="<?php echo e(old('txt_apePaterContacC')); ?>">
				</div>
				<div class="form-group">
					<label for="">Apellido Materno</label>
					<input type="text" name="txt_apeMaterContacC" class="form-control" placeholder="apellido materno..." value="<?php echo e(old('txt_apeMaterContacC')); ?>">
				</div>
				<div class="form-group">
					<label for="">Email</label>
					<input type="email" name="txt_correoContacClien" class="form-control" placeholder="email..." value="<?php echo e(old('txt_correoContacClien')); ?>">
				</div>
				<div class="form-group">
					<label for="">Dirección</label>
					<input type="text" name="txt_direcContacClien" class="form-control" placeholder="dirección..." value="<?php echo e(old('txt_direcContacClien')); ?>">
				</div>
				<div class="form-group">
					<label for="">Distrito</label>
					<input type="text" name="txt_codiDistric" class="form-control" placeholder="distrito..." value="<?php echo e(old('txt_codiDistric')); ?>">
				</div>
				<div class="form-group">
					<label for="">Provincia</label>
					<input type="text" name="txt_codiProvinc" class="form-control" placeholder="provincia..." value="<?php echo e(old('txt_codiProvinc')); ?>">
				</div>
				<div class="form-group">
					<label for="">Departamento</label>
					<input type="text" name="txt_codiDeparc" class="form-control" placeholder="departamento..." value="<?php echo e(old('txt_codiDeparc')); ?>">
				</div>
				<div class="form-group">
					<label for="">Celular 01</label>
					<input type="text" name="txt_celu01ContacClien" class="form-control" placeholder="celular 01..." value="<?php echo e(old('txt_celu01ContacClien')); ?>">
				</div>
				<div class="form-group">
					<label for="">Celular 02</label>
					<input type="text" name="txt_celu02ContacClien" class="form-control" placeholder="celular 02..." value="<?php echo e(old('txt_celu02ContacClien')); ?>">
				</div>
				<div class="form-group">
					<label for="">Teléfono</label>
					<input type="text" name="txt_teleContacClien" class="form-control" placeholder="teléfono..." value="<?php echo e(old('txt_teleContacClien')); ?>">
				</div>
				<div class="form-group">
					<label for="">Anexo</label>
					<input type="text" name="txt_aneContacClien" class="form-control" placeholder="anexo..." value="<?php echo e(old('txt_aneContacClien')); ?>">
				</div>
				<div class="form-group">
					<label for="">Cliente</label>
					<input type="text" name="txt_codiClienJuri" class="form-control" placeholder="cliente..." value="<?php echo e(old('txt_codiClienJuri')); ?>">
				</div>
...
//        });
		...
		$('.modal-footer-contac').on('click', '.add-contac', function() {
			datos = {
				...
				$.ajax({
					type: 'POST',
					url: "<?php echo e(URL::to('contactosCliente')); ?>",
					data: datos,
					success: function(response) {
							console.log(response);
						}
        ...
        $(document).on('click', '.del-delItem', function() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(URL::to('delCosteoItem')); ?>",
                data: datos,
                success: function(response) {
                    console.log(response);
