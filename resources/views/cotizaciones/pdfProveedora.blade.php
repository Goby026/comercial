...
<body>
<div id="header">
    <center><img src="{{ public_path('/imagenes/proveedora/Proveedora-1.jpg') }}"
                 style="width: 100%; height: 80px;"></center>
</div>  <!-- Custom HTML footer -->
<div id="footer">
    <img src="{{ public_path('/imagenes/proveedora/Proveedora-2.jpg') }}" style="width: 100%; height: 90px;" alt="">
</div>
<div class="container">
    <div class="col-md-12">
        <div class="row">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td width="100" style="text-align: center;">
                                <b>
                                    @if($costeo->currency == 0)
                                        S/ {{ number_format( $kit->precioUniSoles, 2, '.', ',' ) }}
                                    @else
                                        $ @convert($kit->precioUniSoles/$dolar->dolarVenta)
                                    @endif
                                </b>
                            </td>
                            <td width="100" style="text-align: center;">
                                <b>
                                    @if($costeo->currency == 0)
                                        S/ {{ number_format( $kit->precioTotal, 2, '.', ',' ) }}
                                    @else
                                        {{--$ {{ number_format( ($producto->precioTotal/$dolar->dolarVenta), 2, '.') }}--}}
                                        $ @convert($kit->precioTotal/$dolar->dolarVenta)
                                    @endif
                                </b>
                            </td>
                        </tr>
                    ...
                    <div style="width: 100%; padding: 5px; margin-left: 37px;">
                        <table>
                            <tr>
                                <td>
                                    @foreach($productos as $producto)
                                        @if($producto->codiCosteo === $kit->codiCosteo)
    ...
    <div>
        <div style="margin-top: 5px; padding: 0px; text-align: left; margin-top: {{ $cotizacion->margen_firma }}px; margin-left: 500px">
            ...
            <ul style="list-style-type: none; margin: 0; padding: 0;">
                ...
                <li>{{ $colaborador->correoProveedora }}</li>
