...
<body>
<div id="header">
    <center><img src="{{ public_path('/imagenes/anie/annie1.jpg') }}"
                 style="width: 100%; height: 80px;"></center>
</div>  <!-- Custom HTML footer -->
<div id="footer">
    <img src="{{ public_path('/imagenes/anie/annie2.jpg') }}" style="width: 99%; height: 80px;" alt="">
</div>
<div class="container">
    <div class="col-md-12">
        <div class="row">
