...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href="{{url('partesPC')}}"><i class="fa fa-circle-o"></i> Partes de pc</a></li>
        ...
        <li><a href="{{url('cartaPresentacion')}}"><i class="fa fa-circle-o"></i> Carta de presentación</a>
        </li>
        <li><a href="{{url('tipoCartaPresen')}}"><i class="fa fa-circle-o"></i> Tipo de carta de
                presentación</a></li>
        <li><a href="{{url('costeoEstados')}}"><i class="fa fa-circle-o"></i> Estados de costeo</a></li>
        <li><a href="{{url('cotizacionEstados')}}"><i class="fa fa-circle-o"></i> Estados de cotización</a>
        </li>
        <li><a href="{{url('condicionesComerciales')}}"><i class="fa fa-circle-o"></i> Condiciones
                comerciales</a></li>
    </ul>
</li>
<li class="treeview">
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href="{{url('tipoClientesJuridicos')}}"><i class="fa fa-circle-o"></i> Tipos de Clientes
                Jurídicos</a></li>
