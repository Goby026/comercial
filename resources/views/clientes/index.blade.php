...
@section ('contenido')
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			<h3>Listado de Tipos de cliente <a href="clientes/create"><button class="btn btn-success pull-right">Nuevo</button></a> </h3>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-condensed table-hover">
					...
					<tbody>
						...
						@include('clientes.modal') <!-- incluimos el archivo del modal -->
						@endforeach
					</tbody>
				</table>
			</div>
